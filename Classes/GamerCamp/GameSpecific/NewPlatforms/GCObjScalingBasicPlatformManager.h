...
//Brandon Middleton
//This class is for managing and drawing multiple basic platforms and grouping them together
...
public:
	CGCObjScalingBasicPlatformManager ();						//Constructor
	virtual ~CGCObjScalingBasicPlatformManager () override;		//Deconstructor
