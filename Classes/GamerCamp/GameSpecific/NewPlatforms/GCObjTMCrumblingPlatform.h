#ifndef _CGCOBJTMCRUMBLINGPLATFORM_
#define _CGCOBJTMCRUMBLINGPLATFORM__
...
class CGCObjTMCrumblingPlatform
...
public:
	...
	CGCObjTMCrumblingPlatform ();												//constructor
	virtual ~CGCObjTMCrumblingPlatform () {};									//deconstructor

	GCFACTORY_DECLARE_CREATABLECLASS (CGCObjTMCrumblingPlatform);
