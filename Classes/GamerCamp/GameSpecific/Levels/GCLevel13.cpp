...
#include "GamerCamp/GameSpecific/Levels/GCLevel14.h"
...
CGCLevel13::CGCLevel13 ()
	: IGCGameLayer (GetGCTypeIDOf (CGCLevel13))
	, m_pcGCTimer (nullptr)
...
void CGCLevel13::keyCollected () // Mia: This function adds one more Key onto how many the Player obtains
{
...
void CGCLevel13::playBackgroundMusic () // Mia: Function that is called when we want the Background Music to play
{
	m_pcGCBackgroundAudio = CocosDenshion::SimpleAudioEngine::getInstance ();
	m_pcGCBackgroundAudio->playBackgroundMusic ("Sounds/BackgroundMusic/CrystalCoralReefSvRV4.wav", true); // Mia: Play Audio by locating File, set to 'True' to loop
}

void CGCLevel13::playKeyAudio () // Mia: Function that is called when we want the Collected Key Sound Effect to play
{
...
void CGCLevel13::playDoorOpeningAudio () // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance ();
...
void CGCLevel13::VOnCreate ()
{
	...
	MenuItemImage* pResetItem // Mia: This button resets the Level
		= MenuItemImage::create ("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1 (CGCLevel13::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem // Mia: This button skips a Level onto the next
		= MenuItemImage::create ("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1 (CGCLevel13::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem // Mia: This button quits the Game back onto the Main Menu
		= MenuItemImage::create ("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1 (CGCLevel13::Callback_OnQuitButton, this));
	...
	// Loads Level
	m_cLevelLoader.LoadLevelFile (FileUtils::getInstance ()->fullPathForFilename (std::string ("OgmoEditor/Level13.oel")).c_str ());
...
void CGCLevel13::PlayerDeathSceneSwap ()
{
...
void CGCLevel13::HighScore ()
{


}

void CGCLevel13::VOnUpdate (f32 fTimeStep)
{
	...
	{
		ReplaceScene (TransitionMoveInR::create (0.1f, TGCGameLayerSceneCreator< CGCLevel14 >::CreateScene ()));
	}
...
void CGCLevel13::Callback_OnQuitButton (Ref* pSender)
{
	RequestQuit ();
}


void CGCLevel13::Callback_OnSkipButton (Ref* pSender)
{
	RequestSkip ();
}

void CGCLevel13::Callback_OnResetButton (Ref* pSender)
{
	RequestReset ();
}
...
void CGCLevel13::BeginContact (b2Contact* pB2Contact)
{
...
void CGCLevel13::EndContact (b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA ();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB ();
...
void CGCLevel13::PreSolve (b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA ();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB ();
...
void CGCLevel13::PostSolve (b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
void CGCLevel13::HandleCollisions ()
{
