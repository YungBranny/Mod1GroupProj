...
CGCLevel4::CGCLevel4()
	: IGCGameLayer(GetGCTypeIDOf(CGCLevel4))
	, m_pcGCTimer(nullptr)
...
void CGCLevel4::keyCollected() // Mia: This function adds one more Key onto how many the Player obtains
{
...
void CGCLevel4::playBackgroundMusic() // Mia: Function that is called when we want the Background Music to play
{
...
void CGCLevel4::playKeyAudio() // Mia: Function that is called when we want the Collected Key Sound Effect to play
{
...
void CGCLevel4::playDoorOpeningAudio() // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance();
...
void CGCLevel4::VOnCreate()
{
	...
	MenuItemImage* pResetItem // Mia: This button resets the Level
		= MenuItemImage::create("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1(CGCLevel4::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem // Mia: This button skips a Level onto the next
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(CGCLevel4::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem // Mia: This button quits the Game back onto the Main Menu
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(CGCLevel4::Callback_OnQuitButton, this));
	...
	cocos2d::Vec2 v2PlayerStartPos (1700, 120);
...
void CGCLevel4::PlayerDeathSceneSwap()
{
...
void CGCLevel4::HighScore()
{


}

void CGCLevel4::VOnUpdate(f32 fTimeStep)
{
...
void CGCLevel4::Callback_OnQuitButton(Ref* pSender)
{
	RequestQuit();
}


void CGCLevel4::Callback_OnSkipButton(Ref* pSender)
{
	RequestSkip();
}

void CGCLevel4::Callback_OnResetButton(Ref* pSender)
{
	RequestReset();
}
...
void CGCLevel4::BeginContact(b2Contact* pB2Contact)
{
...
void CGCLevel4::EndContact(b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
void CGCLevel4::PreSolve(b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
void CGCLevel4::PostSolve(b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
void CGCLevel4::HandleCollisions()
{
