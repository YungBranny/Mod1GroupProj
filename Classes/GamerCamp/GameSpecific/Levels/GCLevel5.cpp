...
CGCLevel5::CGCLevel5()
	: IGCGameLayer(GetGCTypeIDOf(CGCLevel5))
	, m_pcGCTimer(nullptr)
...
void CGCLevel5::keyCollected() // Mia: This function adds one more Key onto how many the Player obtains
{
...
void CGCLevel5::playBackgroundMusic() // Mia: Function that is called when we want the Background Music to play
{
...
void CGCLevel5::playKeyAudio() // Mia: Function that is called when we want the Collected Key Sound Effect to play
{
...
void CGCLevel5::playDoorOpeningAudio() // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance();
...
void CGCLevel5::VOnCreate()
{
	...
	MenuItemImage* pResetItem // Mia: This button resets the Level
		= MenuItemImage::create("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1(CGCLevel5::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem // Mia: This button skips a Level onto the next
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(CGCLevel5::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem // Mia: This button quits the Game back onto the Main Menu
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(CGCLevel5::Callback_OnQuitButton, this));
	...
	cocos2d::Vec2 v2PlayerStartPos(1840, 850);
...
void CGCLevel5::PlayerDeathSceneSwap()
{
...
void CGCLevel5::HighScore()
{


}

void CGCLevel5::VOnUpdate(f32 fTimeStep)
{
...
void CGCLevel5::Callback_OnQuitButton(Ref* pSender)
{
	RequestQuit();
}


void CGCLevel5::Callback_OnSkipButton(Ref* pSender)
{
	RequestSkip();
}

void CGCLevel5::Callback_OnResetButton(Ref* pSender)
{
	RequestReset();
}
...
void CGCLevel5::BeginContact(b2Contact* pB2Contact)
{
...
void CGCLevel5::EndContact(b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
void CGCLevel5::PreSolve(b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
void CGCLevel5::PostSolve(b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
void CGCLevel5::HandleCollisions()
{
