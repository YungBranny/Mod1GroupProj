...
///////////////////////////////////////////////////////////////////////////////
GCLevel7::GCLevel7 ()
	: IGCGameLayer (GetGCTypeIDOf (GCLevel7))
...
void GCLevel7::keyCollected () // Mia: This function adds one more Key onto how many the Player obtains
{
...
void GCLevel7::playBackgroundMusic () // Mia: Function that is called when we want the Background Music to play
{
...
void GCLevel7::playKeyAudio () // Mia: Function that is called when we want the Collected Key Sound Effect to play
{
...
void GCLevel7::playTimerPickUpAudio () // Mia: Function that is called when we want the Timer PickUp Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance ();
...
void GCLevel7::playDoorOpeningAudio () // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance ();
...
void GCLevel7::VOnCreate ()
{
	...
	MenuItemImage* pResetItem
		= MenuItemImage::create ("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1 (GCLevel7::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem
		= MenuItemImage::create ("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1 (GCLevel7::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem
		= MenuItemImage::create ("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1 (GCLevel7::Callback_OnQuitButton, this));
...
void GCLevel7::PlayerDeathSceneSwap ()
{
...
//////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel7::VOnUpdate (f32 fTimeStep)
{
	...
	if (SkipWasRequested ())
	{
		...
		ReplaceScene (TransitionMoveInR::create(0.1f, TGCGameLayerSceneCreator< GCLevel8 >::CreateScene ()));
...
// on quit button
///////////////////////////////////////////////////////////////////////////////
void GCLevel7::Callback_OnQuitButton (Ref* pSender)
{
	RequestQuit ();
}


void GCLevel7::Callback_OnSkipButton (Ref* pSender)
{
	RequestSkip ();
}
...
// on reset button
///////////////////////////////////////////////////////////////////////////////
void GCLevel7::Callback_OnResetButton (Ref* pSender)
{
	RequestReset ();
}
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel7::BeginContact (b2Contact* pB2Contact)
{
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel7::EndContact (b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA ();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB ();
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel7::PreSolve (b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA ();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB ();
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel7::PostSolve (b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
// 
///////////////////////////////////////////////////////////////////////////////
void GCLevel7::HandleCollisions ()
{
