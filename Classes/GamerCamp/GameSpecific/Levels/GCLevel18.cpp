...
#include "GamerCamp/GameSpecific/Levels/GCLevel19.h"
...
CGCLevel18::CGCLevel18()
	: IGCGameLayer(GetGCTypeIDOf(CGCLevel18))
	, m_pcGCTimer(nullptr)
...
void CGCLevel18::keyCollected() // Mia: This function adds one more Key onto how many the Player obtains
{
...
void CGCLevel18::playBackgroundMusic() // Mia: Function that is called when we want the Background Music to play
{
...
void CGCLevel18::playKeyAudio() // Mia: Function that is called when we want the Collected Key Sound Effect to play
{
...
void CGCLevel18::playDoorOpeningAudio() // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance();
...
void CGCLevel18::VOnCreate()
{
	...
	MenuItemImage* pResetItem // Mia: This button resets the Level
		= MenuItemImage::create("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1(CGCLevel18::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem // Mia: This button skips a Level onto the next
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(CGCLevel18::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem // Mia: This button quits the Game back onto the Main Menu
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(CGCLevel18::Callback_OnQuitButton, this));
...
void CGCLevel18::PlayerDeathSceneSwap()
{
...
void CGCLevel18::HighScore()
{


}

void CGCLevel18::VOnUpdate(f32 fTimeStep)
{
	...
	{
		ReplaceScene(TransitionMoveInR::create(0.1f, TGCGameLayerSceneCreator< CGCLevel19 >::CreateScene()));
	}
...
void CGCLevel18::Callback_OnQuitButton(Ref* pSender)
{
	RequestQuit();
}


void CGCLevel18::Callback_OnSkipButton(Ref* pSender)
{
	RequestSkip();
}

void CGCLevel18::Callback_OnResetButton(Ref* pSender)
{
	RequestReset();
}
...
void CGCLevel18::BeginContact(b2Contact* pB2Contact)
{
...
void CGCLevel18::EndContact(b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
void CGCLevel18::PreSolve(b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
void CGCLevel18::PostSolve(b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
void CGCLevel18::HandleCollisions()
{
