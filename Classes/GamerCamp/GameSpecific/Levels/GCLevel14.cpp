...
CGCLevel14::CGCLevel14 ()
	: IGCGameLayer (GetGCTypeIDOf (CGCLevel14))
	, m_pcGCTimer (nullptr)
...
void CGCLevel14::keyCollected () // Mia: This function adds one more Key onto how many the Player obtains
{
...
void CGCLevel14::playDoorOpeningAudio () // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance ();
...
void CGCLevel14::VOnCreate ()
{
	...
	MenuItemImage* pResetItem // Mia: This button resets the Level
		= MenuItemImage::create ("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1 (CGCLevel14::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem // Mia: This button skips a Level onto the next
		= MenuItemImage::create ("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1 (CGCLevel14::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem // Mia: This button quits the Game back onto the Main Menu
		= MenuItemImage::create ("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1 (CGCLevel14::Callback_OnQuitButton, this));
...
void CGCLevel14::PlayerDeathSceneSwap ()
{
...
void CGCLevel14::HighScore ()
{


}

void CGCLevel14::VOnUpdate (f32 fTimeStep)
{
	...
	{
		ReplaceScene (TransitionMoveInR::create (0.1f, TGCGameLayerSceneCreator< CGCLevel15 >::CreateScene ()));
	}
...
void CGCLevel14::Callback_OnQuitButton (Ref* pSender)
{
	RequestQuit ();
}


void CGCLevel14::Callback_OnSkipButton (Ref* pSender)
{
	RequestSkip ();
}

void CGCLevel14::Callback_OnResetButton (Ref* pSender)
{
	RequestReset ();
}
...
void CGCLevel14::BeginContact (b2Contact* pB2Contact)
{
...
void CGCLevel14::EndContact (b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA ();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB ();
...
void CGCLevel14::PreSolve (b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA ();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB ();
...
void CGCLevel14::PostSolve (b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
void CGCLevel14::HandleCollisions ()
{
