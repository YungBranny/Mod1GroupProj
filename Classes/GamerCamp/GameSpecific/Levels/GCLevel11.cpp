...
#include "GamerCamp/GameSpecific/Levels/GCLevel12.h"
...
CGCLevel11::CGCLevel11 ()
	: IGCGameLayer (GetGCTypeIDOf (CGCLevel11))
	, m_pcGCTimer (nullptr)
...
void CGCLevel11::keyCollected () // Mia: This function adds one more Key onto how many the Player obtains
{
...
void CGCLevel11::playBackgroundMusic () // Mia: Function that is called when we want the Background Music to play
{
	m_pcGCBackgroundAudio = CocosDenshion::SimpleAudioEngine::getInstance ();
	m_pcGCBackgroundAudio->playBackgroundMusic ("Sounds/BackgroundMusic/DeepSeaOilRigSvRV3.wav", true); // Mia: Play Audio by locating File, set to 'True' to loop
}

void CGCLevel11::playKeyAudio () // Mia: Function that is called when we want the Collected Key Sound Effect to play
{
...
void CGCLevel11::playDoorOpeningAudio () // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance ();
...
void CGCLevel11::VOnCreate ()
{
	...
	MenuItemImage* pResetItem // Mia: This button resets the Level
		= MenuItemImage::create ("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1 (CGCLevel11::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem // Mia: This button skips a Level onto the next
		= MenuItemImage::create ("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1 (CGCLevel11::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem // Mia: This button quits the Game back onto the Main Menu
		= MenuItemImage::create ("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1 (CGCLevel11::Callback_OnQuitButton, this));
...
void CGCLevel11::PlayerDeathSceneSwap ()
{
...
void CGCLevel11::HighScore ()
{


}

void CGCLevel11::VOnUpdate (f32 fTimeStep)
{
	...
	{
		ReplaceScene (TransitionMoveInR::create (0.1f, TGCGameLayerSceneCreator< CGCLevel12 >::CreateScene ()));
	}
...
void CGCLevel11::Callback_OnQuitButton (Ref* pSender)
{
	RequestQuit ();
}


void CGCLevel11::Callback_OnSkipButton (Ref* pSender)
{
	RequestSkip ();
}

void CGCLevel11::Callback_OnResetButton (Ref* pSender)
{
	RequestReset ();
}
...
void CGCLevel11::BeginContact (b2Contact* pB2Contact)
{
...
void CGCLevel11::EndContact (b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA ();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB ();
...
void CGCLevel11::PreSolve (b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA ();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB ();
...
void CGCLevel11::PostSolve (b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
void CGCLevel11::HandleCollisions ()
{
