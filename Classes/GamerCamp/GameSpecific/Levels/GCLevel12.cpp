...
///////////////////////////////////////////////////////////////////////////////
GCLevel12::GCLevel12()
	: IGCGameLayer(GetGCTypeIDOf(GCLevel12))
...
void GCLevel12::keyCollected() // Mia: This function adds one more Key onto how many the Player obtains
{
...
void GCLevel12::playKeyAudio() // Mia: Function that is called when we want the Collected Key Sound Effect to play
{
...
void GCLevel12::playTimerPickUpAudio() // Mia: Function that is called when we want the Timer PickUp Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance();
...
void GCLevel12::playDoorOpeningAudio() // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance();
...
void GCLevel12::VOnCreate()
{
	...
	MenuItemImage* pResetItem
		= MenuItemImage::create("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1(GCLevel12::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(GCLevel12::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(GCLevel12::Callback_OnQuitButton, this));
...
void GCLevel12::PlayerDeathSceneSwap()
{
...
//////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel12::VOnUpdate(f32 fTimeStep)
{
	...
	if (SkipWasRequested())
	{
		...
		ReplaceScene(TransitionRotoZoom::create(1.0f, TGCGameLayerSceneCreator< GCLevel13 >::CreateScene()));
...
// on quit button
///////////////////////////////////////////////////////////////////////////////
void GCLevel12::Callback_OnQuitButton(Ref* pSender)
{
	RequestQuit();
}


void GCLevel12::Callback_OnSkipButton(Ref* pSender)
{
	RequestSkip();
}
...
// on reset button
///////////////////////////////////////////////////////////////////////////////
void GCLevel12::Callback_OnResetButton(Ref* pSender)
{
	RequestReset();
}
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel12::BeginContact(b2Contact* pB2Contact)
{
			...
			&& ( pGcSprPhysB->GetGCTypeID () == GetGCTypeIDOf (CGCObjExitDoor) ) ))
	{
		if (m_iKeysCollected >= m_iTotalKeys) // Mia: If the Keys Collected by Player is more than or equal than to the Total Keys Collected
		{
			...
			ReplaceScene (TransitionMoveInR::create (0.1f, TGCGameLayerSceneCreator< GCLevel13 >::CreateScene ()));
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel12::EndContact(b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel12::PreSolve(b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel12::PostSolve(b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
// 
///////////////////////////////////////////////////////////////////////////////
void GCLevel12::HandleCollisions()
{
