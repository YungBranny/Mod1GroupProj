...
#include "GamerCamp/GameSpecific/Levels/GCLevel4.h"
...
CGCLevel3::CGCLevel3()
	: IGCGameLayer(GetGCTypeIDOf(CGCLevel3))
	, m_pcGCTimer(nullptr)
...
void CGCLevel3::keyCollected() // Mia: This function adds one more Key onto how many the Player obtains
{
...
void CGCLevel3::playBackgroundMusic() // Mia: Function that is called when we want the Background Music to play
{
...
void CGCLevel3::playKeyAudio() // Mia: Function that is called when we want the Collected Key Sound Effect to play
{
...
void CGCLevel3::playDoorOpeningAudio() // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance();
...
void CGCLevel3::VOnCreate()
{
	...
	MenuItemImage* pResetItem // Mia: This button resets the Level
		= MenuItemImage::create("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1(CGCLevel3::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem // Mia: This button skips a Level onto the next
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(CGCLevel3::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem // Mia: This button quits the Game back onto the Main Menu
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(CGCLevel3::Callback_OnQuitButton, this));
...
void CGCLevel3::PlayerDeathSceneSwap()
{
...
void CGCLevel3::HighScore()
{


}

void CGCLevel3::VOnUpdate(f32 fTimeStep)
{
	...
	{
		ReplaceScene(TransitionMoveInR::create(0.1f, TGCGameLayerSceneCreator< CGCLevel4 >::CreateScene()));
	}
...
void CGCLevel3::Callback_OnQuitButton(Ref* pSender)
{
	RequestQuit();
}


void CGCLevel3::Callback_OnSkipButton(Ref* pSender)
{
	RequestSkip();
}

void CGCLevel3::Callback_OnResetButton(Ref* pSender)
{
	RequestReset();
}
...
void CGCLevel3::BeginContact(b2Contact* pB2Contact)
{
...
void CGCLevel3::EndContact(b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
void CGCLevel3::PreSolve(b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
void CGCLevel3::PostSolve(b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
void CGCLevel3::HandleCollisions()
{
