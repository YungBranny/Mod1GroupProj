...
///////////////////////////////////////////////////////////////////////////////
GCLevel6::GCLevel6 ()
	: IGCGameLayer (GetGCTypeIDOf (GCLevel6))
...
void GCLevel6::keyCollected () // Mia: This function adds one more Key onto how many the Player obtains
{
...
void GCLevel6::playBackgroundMusic() // Mia: Function that is called when we want the Background Music to play
{
...
void GCLevel6::playKeyAudio () // Mia: Function that is called when we want the Collected Key Sound Effect to play
{
...
void GCLevel6::playTimerPickUpAudio () // Mia: Function that is called when we want the Timer PickUp Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance ();
...
void GCLevel6::playDoorOpeningAudio () // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance ();
...
void GCLevel6::VOnCreate ()
{
	...
	MenuItemImage* pResetItem
		= MenuItemImage::create ("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1 (GCLevel6::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem
		= MenuItemImage::create ("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1 (GCLevel6::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem
		= MenuItemImage::create ("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1 (GCLevel6::Callback_OnQuitButton, this));
...
void GCLevel6::PlayerDeathSceneSwap ()
{
...
//////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel6::VOnUpdate (f32 fTimeStep)
{
...
// on quit button
///////////////////////////////////////////////////////////////////////////////
void GCLevel6::Callback_OnQuitButton (Ref* pSender)
{
	RequestQuit ();
}


void GCLevel6::Callback_OnSkipButton (Ref* pSender)
{
	RequestSkip ();
}
...
// on reset button
///////////////////////////////////////////////////////////////////////////////
void GCLevel6::Callback_OnResetButton (Ref* pSender)
{
	RequestReset ();
}
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel6::BeginContact (b2Contact* pB2Contact)
{
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel6::EndContact (b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA ();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB ();
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel6::PreSolve (b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA ();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB ();
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel6::PostSolve (b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
// 
///////////////////////////////////////////////////////////////////////////////
void GCLevel6::HandleCollisions ()
{
