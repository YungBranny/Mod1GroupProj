...
CGCLevel20::CGCLevel20()
	: IGCGameLayer(GetGCTypeIDOf(CGCLevel20))
	, m_pcGCTimer(nullptr)
...
void CGCLevel20::keyCollected() // Mia: This function adds one more Key onto how many the Player obtains
{
...
void CGCLevel20::playBackgroundMusic() // Mia: Function that is called when we want the Background Music to play
{
	m_pcGCBackgroundAudio = CocosDenshion::SimpleAudioEngine::getInstance();
	m_pcGCBackgroundAudio->playBackgroundMusic("Sounds/BackgroundMusic/Shipwreck_v2 - Dub.wav", true); // Mia: Play Audio by locating File, set to 'True' to loop
}

void CGCLevel20::playKeyAudio() // Mia: Function that is called when we want the Collected Key Sound Effect to play
{
...
void CGCLevel20::playDoorOpeningAudio() // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance();
...
void CGCLevel20::VOnCreate()
{
	...
	MenuItemImage* pResetItem // Mia: This button resets the Level
		= MenuItemImage::create("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1(CGCLevel20::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem // Mia: This button skips a Level onto the next
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(CGCLevel20::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem // Mia: This button quits the Game back onto the Main Menu
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(CGCLevel20::Callback_OnQuitButton, this));
...
void CGCLevel20::PlayerDeathSceneSwap()
{
...
void CGCLevel20::HighScore()
{


}

void CGCLevel20::VOnUpdate(f32 fTimeStep)
{
...
void CGCLevel20::Callback_OnQuitButton(Ref* pSender)
{
	RequestQuit();
}


void CGCLevel20::Callback_OnSkipButton(Ref* pSender)
{
	RequestSkip();
}

void CGCLevel20::Callback_OnResetButton(Ref* pSender)
{
	RequestReset();
}
...
void CGCLevel20::BeginContact(b2Contact* pB2Contact)
{
...
void CGCLevel20::EndContact(b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
void CGCLevel20::PreSolve(b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
void CGCLevel20::PostSolve(b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
void CGCLevel20::HandleCollisions()
{
