...
///////////////////////////////////////////////////////////////////////////////
GCLevel10::GCLevel10()
	: IGCGameLayer(GetGCTypeIDOf(GCLevel10))
...
void GCLevel10::keyCollected() // Mia: This function adds one more Key onto how many the Player obtains
{
...
void GCLevel10::playKeyAudio() // Mia: Function that is called when we want the Collected Key Sound Effect to play
{
...
void GCLevel10::playTimerPickUpAudio() // Mia: Function that is called when we want the Timer PickUp Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance();
...
void GCLevel10::playDoorOpeningAudio() // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance();
...
void GCLevel10::VOnCreate()
{
	...
	MenuItemImage* pResetItem
		= MenuItemImage::create("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1(GCLevel10::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(GCLevel10::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(GCLevel10::Callback_OnQuitButton, this));
...
void GCLevel10::PlayerDeathSceneSwap()
{
...
//////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel10::VOnUpdate(f32 fTimeStep)
{
	...
	if (SkipWasRequested())
	{
		...
		ReplaceScene(TransitionRotoZoom::create(1.0f, TGCGameLayerSceneCreator< GCLevel11 >::CreateScene()));
...
// on quit button
///////////////////////////////////////////////////////////////////////////////
void GCLevel10::Callback_OnQuitButton(Ref* pSender)
{
	RequestQuit();
}


void GCLevel10::Callback_OnSkipButton(Ref* pSender)
{
	RequestSkip();
}
...
// on reset button
///////////////////////////////////////////////////////////////////////////////
void GCLevel10::Callback_OnResetButton(Ref* pSender)
{
	RequestReset();
}
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel10::BeginContact(b2Contact* pB2Contact)
{
			...
			&& ( pGcSprPhysB->GetGCTypeID () == GetGCTypeIDOf (CGCObjExitDoor) ) ))
	{
		if (m_iKeysCollected >= m_iTotalKeys) // Mia: If the Keys Collected by Player is more than or equal than to the Total Keys Collected
		{
			...
			ReplaceScene (TransitionMoveInR::create (0.1f, TGCGameLayerSceneCreator< GCLevel11 >::CreateScene ()));
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel10::EndContact(b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel10::PreSolve(b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
///////////////////////////////////////////////////////////////////////////////
//virtual 
void GCLevel10::PostSolve(b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
// 
///////////////////////////////////////////////////////////////////////////////
void GCLevel10::HandleCollisions()
{
