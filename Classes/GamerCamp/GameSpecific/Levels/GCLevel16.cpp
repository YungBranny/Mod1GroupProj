...
#include "GamerCamp/GameSpecific/Levels/GCLevel17.h"
...
CGCLevel16::CGCLevel16()
	: IGCGameLayer(GetGCTypeIDOf(CGCLevel16))
	, m_pcGCTimer(nullptr)
...
void CGCLevel16::keyCollected() // Mia: This function adds one more Key onto how many the Player obtains
{
...
void CGCLevel16::playBackgroundMusic() // Mia: Function that is called when we want the Background Music to play
{
	m_pcGCBackgroundAudio = CocosDenshion::SimpleAudioEngine::getInstance();
	m_pcGCBackgroundAudio->playBackgroundMusic("Sounds/BackgroundMusic/Shipwreck_v1 - Main.wav", true); // Mia: Play Audio by locating File, set to 'True' to loop
}

void CGCLevel16::playKeyAudio() // Mia: Function that is called when we want the Collected Key Sound Effect to play
{
...
void CGCLevel16::playDoorOpeningAudio() // Mia: Function that is called when we want the Door Opened Sound Effect to play
{
	m_pcGCSoundEffectsAudio = CocosDenshion::SimpleAudioEngine::getInstance();
...
void CGCLevel16::VOnCreate()
{
	...
	MenuItemImage* pResetItem // Mia: This button resets the Level
		= MenuItemImage::create("Loose/CloseNormal.png",
			...
			CC_CALLBACK_1(CGCLevel16::Callback_OnResetButton, this));
	...
	MenuItemImage* pSkipItem // Mia: This button skips a Level onto the next
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(CGCLevel16::Callback_OnSkipButton, this));
	...
	MenuItemImage* pQuitItem // Mia: This button quits the Game back onto the Main Menu
		= MenuItemImage::create("Loose/CloseNormal.png",
			"Loose/CloseSelected.png",
			CC_CALLBACK_1(CGCLevel16::Callback_OnQuitButton, this));
...
void CGCLevel16::PlayerDeathSceneSwap()
{
...
void CGCLevel16::HighScore()
{


}

void CGCLevel16::VOnUpdate(f32 fTimeStep)
{
	...
	{
		ReplaceScene(TransitionMoveInR::create(0.1f, TGCGameLayerSceneCreator< CGCLevel17 >::CreateScene()));
	}
...
void CGCLevel16::Callback_OnQuitButton(Ref* pSender)
{
	RequestQuit();
}


void CGCLevel16::Callback_OnSkipButton(Ref* pSender)
{
	RequestSkip();
}

void CGCLevel16::Callback_OnResetButton(Ref* pSender)
{
	RequestReset();
}
...
void CGCLevel16::BeginContact(b2Contact* pB2Contact)
{
...
void CGCLevel16::EndContact(b2Contact* pB2Contact)
{
	{
		const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
		const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
void CGCLevel16::PreSolve(b2Contact* pB2Contact, const b2Manifold* pOldManifold)
{
	const b2Fixture* pFixtureA = pB2Contact->GetFixtureA();
	const b2Fixture* pFixtureB = pB2Contact->GetFixtureB();
...
void CGCLevel16::PostSolve(b2Contact* pB2Contact, const b2ContactImpulse* pImpulse)
{
}
...
void CGCLevel16::HandleCollisions()
{
