#ifndef _CGCOBJTCRCRUMBLINGPLATFORM_
#define _CGCOBJTCRCRUMBLINGPLATFORM__
...
class CGCObjTCRCrumblingPlatform
...
public:
	...
	CGCObjTCRCrumblingPlatform ();												//constructor
	virtual ~CGCObjTCRCrumblingPlatform () {};									//deconstructor

	GCFACTORY_DECLARE_CREATABLECLASS (CGCObjTCRCrumblingPlatform);
