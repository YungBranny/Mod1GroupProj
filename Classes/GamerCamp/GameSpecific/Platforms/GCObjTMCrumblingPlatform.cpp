...
#include "GCObjTMCrumblingPlatform.h"

#include "../../GCCocosInterface/GB2ShapeCache-x.h"

GCFACTORY_IMPLEMENT_CREATEABLECLASS (CGCObjTMCrumblingPlatform);


CGCObjTMCrumblingPlatform::CGCObjTMCrumblingPlatform ()
...
void CGCObjTMCrumblingPlatform::VOnResourceAcquire ()
{
	...
	const char* pszAnim_Idle = "TMIdle";
...
void CGCObjTMCrumblingPlatform::VOnReset ()
{
...
void CGCObjTMCrumblingPlatform::MoveDownOnContact ()
{
...
void CGCObjTMCrumblingPlatform::VHandleFactoryParams (const CGCFactoryCreationParams& rCreationParams, cocos2d::Vec2 v2InitialPosition)
{
...
//update function
void CGCObjTMCrumblingPlatform::VOnUpdate (f32 fTimestep)
{
	MoveDownOnContact ();
}
