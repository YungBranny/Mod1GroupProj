#ifndef _GCMOVINGENEMEMYUPDOWNFAST_
#define _GCMOVINGENEMEMYUPDOWNFAST_
...
public:
	...
	CGCMovingEnemyUpDownFast ();
	virtual ~CGCMovingEnemyUpDownFast () {};

	GCFACTORY_DECLARE_CREATABLECLASS (CGCMovingEnemyUpDownFast);
