#ifndef _GCMOVINGENEMEMYPUFFER_
#define _GCMOVINGENEMEMYPUFFER_
...
public:
	...
	CGCMovingEnemyPuffer ();
	virtual ~CGCMovingEnemyPuffer () {};

	GCFACTORY_DECLARE_CREATABLECLASS (CGCMovingEnemyPuffer);
