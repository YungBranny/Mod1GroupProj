#ifndef _GCMOVINGENEMEMYUPDOWNSLOW_
#define _GCMOVINGENEMEMYUPDOWNSLOW_
...
public:
	...
	CGCMovingEnemyUpDownSlow ();
	virtual ~CGCMovingEnemyUpDownSlow () {};

	GCFACTORY_DECLARE_CREATABLECLASS (CGCMovingEnemyUpDownSlow);
