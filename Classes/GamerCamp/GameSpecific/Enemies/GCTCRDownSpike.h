#ifndef _GCTCRDOWNSPIKE_
#define _GCTCRDOWNSPIKE_
...
public:
	...
	CGCTCRDownSpike ();										//constructor
	virtual ~CGCTCRDownSpike () {};							//deconstructor

	GCFACTORY_DECLARE_CREATABLECLASS (CGCTCRDownSpike);
