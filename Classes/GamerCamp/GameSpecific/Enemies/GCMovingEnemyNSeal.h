#ifndef _GCMOVINGENEMIESSEAL_
#define _GCMOVINGENEMIESSEAL_
...
public:
	...
	CGCMovingEnemyNSeal ();
	virtual ~CGCMovingEnemyNSeal () {};

	GCFACTORY_DECLARE_CREATABLECLASS (CGCMovingEnemyNSeal);
