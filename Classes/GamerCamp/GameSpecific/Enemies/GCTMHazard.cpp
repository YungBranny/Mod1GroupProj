...
GCFACTORY_IMPLEMENT_CREATEABLECLASS (CGCTMHazard);

CGCTMHazard::CGCTMHazard ()
	: CGCObjSpritePhysics (GetGCTypeIDOf (CGCBasicEnemies))
{

}

void CGCTMHazard::VOnResourceAcquire ()
{
	CGCObjSpritePhysics::VOnResourceAcquire ();
	const char* pszAnim_Idle = "TMHazard";
...
void CGCTMHazard::VOnReset ()
{
	CGCObjSpritePhysics::VOnReset ();
}
void CGCTMHazard::VOnUpdate (f32 fTimestep)
{
	CGCObjSpritePhysics::VOnUpdate (fTimestep);
}

void CGCTMHazard::VOnResourceRelease ()
{
...
void CGCTMHazard::VOnResurrected ()
{
	CGCObjSpritePhysics::VOnResurrected ();
}

void CGCTMHazard::VHandleFactoryParams (const CGCFactoryCreationParams& rCreationParams, cocos2d::Vec2 v2InitialPosition)
{
