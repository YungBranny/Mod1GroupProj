...
#include "GCMovingEnemyUpDownSlow.h"
...
GCFACTORY_IMPLEMENT_CREATEABLECLASS (CGCMovingEnemyUpDownSlow);

CGCMovingEnemyUpDownSlow::CGCMovingEnemyUpDownSlow ()
...
void CGCMovingEnemyUpDownSlow::InitialiseMovementDirection ()
{
...
void CGCMovingEnemyUpDownSlow::VOnResourceRelease ()
{
...
void CGCMovingEnemyUpDownSlow::ChangeDirection ()
{
	if (m_bMovingLeftAndRight == true)
	{
...
void CGCMovingEnemyUpDownSlow::Movement () //changes the velocity depending on the direction it is going
{
	switch (m_eMoveDirection)
	{
	case EMoveDirection::Right:
...
void CGCMovingEnemyUpDownSlow::CollisionChecker ()
{
...
void CGCMovingEnemyUpDownSlow::CollisionDirChecker ()
{
	{
...
void CGCMovingEnemyUpDownSlow::VHandleFactoryParams (const CGCFactoryCreationParams& rCreationParams, cocos2d::Vec2 v2InitialPosition)
{
...
void CGCMovingEnemyUpDownSlow::VOnUpdate (f32 fTimeStep)
{
	ChangeDirection ();
	Movement ();
	CollisionChecker ();
