#ifndef _GCMOVINGENEMEMYUPDOWN_
#define _GCMOVINGENEMEMYUPDOWN_
...
public:
	...
	CGCMovingEnemyUpDown ();
	virtual ~CGCMovingEnemyUpDown () {};

	GCFACTORY_DECLARE_CREATABLECLASS (CGCMovingEnemyUpDown);
