#ifndef _GCMOVINGENEMIESPENGUIN_
#define _GCMOVINGENEMIESPENGUIN_
...
public:
	...
	CGCMovingEnemyNPenguin ();
	virtual ~CGCMovingEnemyNPenguin () {};

	GCFACTORY_DECLARE_CREATABLECLASS (CGCMovingEnemyNPenguin);
