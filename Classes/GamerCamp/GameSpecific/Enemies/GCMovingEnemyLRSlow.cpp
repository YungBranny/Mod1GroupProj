...
GCFACTORY_IMPLEMENT_CREATEABLECLASS (CGCMovingEnemyLRSlow);

CGCMovingEnemyLRSlow::CGCMovingEnemyLRSlow ()
...
void CGCMovingEnemyLRSlow::VOnResurrected (void)
{
...
void CGCMovingEnemyLRSlow::InitialiseMovementDirection ()
{
...
//Sets the sprite
void CGCMovingEnemyLRSlow::VOnResourceAcquire ()
{
...
void CGCMovingEnemyLRSlow::VOnResourceRelease ()
{
...
void CGCMovingEnemyLRSlow::ChangeDirection ()
{
	if (m_bMovingLeftAndRight == true)
	{
...
void CGCMovingEnemyLRSlow::Movement () //changes the velocity depending on the direction it is going
{
	switch (m_eMoveDirection)
	{
	case EMoveDirection::Right:
...
void CGCMovingEnemyLRSlow::CollisionChecker ()
{
...
void CGCMovingEnemyLRSlow::CollisionDirChecker ()
{
	{
...
void CGCMovingEnemyLRSlow::VHandleFactoryParams (const CGCFactoryCreationParams& rCreationParams, cocos2d::Vec2 v2InitialPosition)
{
...
void CGCMovingEnemyLRSlow::VOnUpdate (f32 fTimeStep)
{
	ChangeDirection ();
	Movement ();
	CollisionChecker ();
