#ifndef _GCMOVINGENEMIESPIRATE_
#define _GCMOVINGENEMIESPIRATE_
...
public:
	...
	CGCMovingEnemyNPirate ();
	virtual ~CGCMovingEnemyNPirate () {};

	GCFACTORY_DECLARE_CREATABLECLASS (CGCMovingEnemyNPirate);
