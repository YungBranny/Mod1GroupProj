#ifndef _GCMOVINGENEMEMYLRSLOW_
#define _GCMOVINGENEMEMYLRSLOW_
...
public:
	...
	CGCMovingEnemyLRSlow ();
	virtual ~CGCMovingEnemyLRSlow () {};

	GCFACTORY_DECLARE_CREATABLECLASS (CGCMovingEnemyLRSlow);
