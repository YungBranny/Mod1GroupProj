...
#include "GCOFallingPlane11.h"

GCFACTORY_IMPLEMENT_CREATEABLECLASS	( CGCObjFallingPlane11 );

CGCObjFallingPlane11::CGCObjFallingPlane11()
...
void CGCObjFallingPlane11::InitialiseMovementDirection()
{
		m_eMoveDirection = EMoveDirection::Down; // Initialises movement
}

void CGCObjFallingPlane11::VOnResourceAcquire()
{
...
void CGCObjFallingPlane11::VOnResurrected(void)
{
...
void CGCObjFallingPlane11::SettingVelocity()
{
...
void CGCObjFallingPlane11::ResetPosition() // Resets Planes position back to start position when this function is collided on collision
{
	GetPhysicsBody()->SetTransform(getStartPosition(), 0);
}

void CGCObjFallingPlane11::CollisionChecker()
{
...
void CGCObjFallingPlane11::VHandleFactoryParams(const CGCFactoryCreationParams& rCreationParams, cocos2d::Vec2 v2InitialPosition)
{
...
void CGCObjFallingPlane11::VOnUpdate(f32 fTimeStep)
{
