...
#include "GCOFallingPlane5.h"

GCFACTORY_IMPLEMENT_CREATEABLECLASS	( CGCObjFallingPlane5 );

CGCObjFallingPlane5::CGCObjFallingPlane5()
...
void CGCObjFallingPlane5::InitialiseMovementDirection()
{
		m_eMoveDirection = EMoveDirection::Down; // Initialises movement
}

void CGCObjFallingPlane5::VOnResourceAcquire()
{
...
void CGCObjFallingPlane5::VOnResurrected(void)
{
...
void CGCObjFallingPlane5::SettingVelocity()
{
...
void CGCObjFallingPlane5::ResetPosition() // Resets Planes position back to start position when this function is collided on collision
{
	GetPhysicsBody()->SetTransform(getStartPosition(), 0);
}

void CGCObjFallingPlane5::CollisionChecker()
{
...
void CGCObjFallingPlane5::VHandleFactoryParams(const CGCFactoryCreationParams& rCreationParams, cocos2d::Vec2 v2InitialPosition)
{
...
void CGCObjFallingPlane5::VOnUpdate(f32 fTimeStep)
{
