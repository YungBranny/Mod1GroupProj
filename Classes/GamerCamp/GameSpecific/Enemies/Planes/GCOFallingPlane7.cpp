...
#include "GCOFallingPlane7.h"

GCFACTORY_IMPLEMENT_CREATEABLECLASS	( CGCObjFallingPlane7 );

CGCObjFallingPlane7::CGCObjFallingPlane7()
	: CGCObjSpritePhysics ( GetGCTypeIDOf ( CGCObjFallingPlane ) )
	, m_bJustCollided		  ( false ) // Default Key collision set to False
	, m_v2MoveUpVelocity	  ( cocos2d::Vec2 ( 0.0f, 9.0f ) ) // Sets up movement velocity
...
void CGCObjFallingPlane7::InitialiseMovementDirection()
{
		m_eMoveDirection = EMoveDirection::Down; // Initialises movement
}

void CGCObjFallingPlane7::VOnResourceAcquire()
{
...
void CGCObjFallingPlane7::VOnResurrected(void)
{
...
void CGCObjFallingPlane7::SettingVelocity()
{
...
void CGCObjFallingPlane7::ResetPosition() // Resets Planes position back to start position when this function is collided on collision
{
	GetPhysicsBody()->SetTransform(getStartPosition(), 0);
}

void CGCObjFallingPlane7::CollisionChecker()
{
...
void CGCObjFallingPlane7::VHandleFactoryParams(const CGCFactoryCreationParams& rCreationParams, cocos2d::Vec2 v2InitialPosition)
{
...
void CGCObjFallingPlane7::VOnUpdate(f32 fTimeStep)
{
