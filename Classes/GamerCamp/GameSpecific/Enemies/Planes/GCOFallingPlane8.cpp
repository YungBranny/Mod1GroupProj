...
void CGCObjFallingPlane8::VOnResurrected(void)
{
...
void CGCObjFallingPlane8::SettingVelocity()
{
...
void CGCObjFallingPlane8::ResetPosition()
{
	GetPhysicsBody()->SetTransform(getStartPosition(), 0);
}

void CGCObjFallingPlane8::CollisionChecker()
{
...
void CGCObjFallingPlane8::VHandleFactoryParams(const CGCFactoryCreationParams& rCreationParams, cocos2d::Vec2 v2InitialPosition)
{
...
void CGCObjFallingPlane8::VOnUpdate(f32 fTimeStep)
{
	SettingVelocity();
	CollisionChecker();
}