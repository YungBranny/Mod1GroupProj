...
#include "GCOFallingPlane10.h"

GCFACTORY_IMPLEMENT_CREATEABLECLASS	( CGCObjFallingPlane10 );

CGCObjFallingPlane10::CGCObjFallingPlane10()
	: CGCObjSpritePhysics ( GetGCTypeIDOf ( CGCObjFallingPlane ) )
	, m_bJustCollided		  ( false ) // Default Key collision set to False
	, m_v2MoveUpVelocity	  ( cocos2d::Vec2 ( 0.0f, 11.0f ) ) // Sets up movement velocity
...
void CGCObjFallingPlane10::InitialiseMovementDirection()
{
		m_eMoveDirection = EMoveDirection::Down; // Initialises movement
}

void CGCObjFallingPlane10::VOnResourceAcquire()
{
...
void CGCObjFallingPlane10::VOnResurrected(void)
{
...
void CGCObjFallingPlane10::SettingVelocity()
{
...
void CGCObjFallingPlane10::ResetPosition() // Resets Planes position back to start position when this function is collided on collision
{
	GetPhysicsBody()->SetTransform(getStartPosition(), 0);
}

void CGCObjFallingPlane10::CollisionChecker()
{
...
void CGCObjFallingPlane10::VHandleFactoryParams(const CGCFactoryCreationParams& rCreationParams, cocos2d::Vec2 v2InitialPosition)
{
...
void CGCObjFallingPlane10::VOnUpdate(f32 fTimeStep)
{
