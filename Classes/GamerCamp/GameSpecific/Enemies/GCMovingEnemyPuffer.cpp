...
GCFACTORY_IMPLEMENT_CREATEABLECLASS (CGCMovingEnemyPuffer);

CGCMovingEnemyPuffer::CGCMovingEnemyPuffer ()
...
void CGCMovingEnemyPuffer::VOnResurrected (void)
{
...
void CGCMovingEnemyPuffer::InitialiseMovementDirection ()
{
...
void CGCMovingEnemyPuffer::VOnResourceAcquire ()
{
	...
	const char* pszAnim_Idle = "PuIdle";
	if (pszAnim_Idle)
	{
...
void CGCMovingEnemyPuffer::VOnResourceRelease ()
{
...
void CGCMovingEnemyPuffer::ChangeDirection ()
{
	if (m_bMovingLeftAndRight == true)
	{
...
void CGCMovingEnemyPuffer::Movement () //changes the velocity depending on the direction it is going
{
	switch (m_eMoveDirection)
	{
	case EMoveDirection::Right:
...
void CGCMovingEnemyPuffer::CollisionChecker ()
{
...
void CGCMovingEnemyPuffer::CollisionDirChecker ()
{
	{
...
void CGCMovingEnemyPuffer::VHandleFactoryParams (const CGCFactoryCreationParams& rCreationParams, cocos2d::Vec2 v2InitialPosition)
{
...
void CGCMovingEnemyPuffer::VOnUpdate (f32 fTimeStep)
{
	ChangeDirection ();
	Movement ();
	CollisionChecker ();
