#ifndef _GCMOVINGENEMEMYLRFAST_
#define _GCMOVINGENEMEMYLRFAST_
...
public:
	...
	CGCMovingEnemyLRFast ();
	virtual ~CGCMovingEnemyLRFast () {};

	GCFACTORY_DECLARE_CREATABLECLASS (CGCMovingEnemyLRFast);
