...
#include "GCMovingEnemyNPenguin.h"
...
GCFACTORY_IMPLEMENT_CREATEABLECLASS (CGCMovingEnemyNPenguin);

CGCMovingEnemyNPenguin::CGCMovingEnemyNPenguin ()
...
void CGCMovingEnemyNPenguin::VOnResurrected (void)
{
...
void CGCMovingEnemyNPenguin::InitialiseMovementDirection ()
{
...
void CGCMovingEnemyNPenguin::VOnResourceAcquire ()
{
	...
	const char* pszAnim_Idle = "PEnemyIdle";
...
void CGCMovingEnemyNPenguin::VOnResourceRelease ()
{
...
void CGCMovingEnemyNPenguin::ChangeDirection ()
{
	if (m_bMovingLeftAndRight == true)
	{
...
void CGCMovingEnemyNPenguin::Movement () //changes the velocity depending on the direction it is going
{
	switch (m_eMoveDirection)
	{
	case EMoveDirection::Right:
...
void CGCMovingEnemyNPenguin::CollisionChecker ()
{
...
void CGCMovingEnemyNPenguin::CollisionDirChecker ()
{
	{
...
void CGCMovingEnemyNPenguin::VHandleFactoryParams (const CGCFactoryCreationParams& rCreationParams, cocos2d::Vec2 v2InitialPosition)
{
...
void CGCMovingEnemyNPenguin::VOnUpdate (f32 fTimeStep)
{
	ChangeDirection ();
	Movement ();
	CollisionChecker ();
